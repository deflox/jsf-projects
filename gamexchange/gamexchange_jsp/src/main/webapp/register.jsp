...
<html>
    	...
    	<script>
	    	jQuery(document).ready(function (ö) {
	    		...
	    		$("form").submit(function(e){
	    			...
	    			var allElements = [useremail,userpassword,userpasswordrepeat,firstname,lastname,street,streetnumber,city];
	    			...
	    			if (userpassword != userpasswordrepeat) {
	    				error++;
	    				errortext += "<li>The both passwords do not match</li>";	    				
	    			}
	    			...
	    			if (!$.isNumeric(postalcode)) {
	    				error++;
	    				errortext += "<li>The postalcode must be numeric</li>";
	    			}
	    			*/
	...
	<body>
		...
		<div class="container">
			...
			<form method="post" action="/GameXChangeLowlevel/register">
				...
				<div class="row">
			 	 ...
			 	 <input type="submit" value="Sign Up" class="btn btn-primary btn-right">
